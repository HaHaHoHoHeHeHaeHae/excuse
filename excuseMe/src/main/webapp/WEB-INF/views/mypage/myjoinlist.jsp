...
<body class="subpage">
	...
	<%-- <div id="subm">
		...
		<br> <a href="<%=request.getContextPath()%>/mypage/wishlist"
			...
			동호회</a><br>
		<br> <a href="<%=request.getContextPath()%>/mypage/myreply" class="atag"
	...
	<div id="sidebar" style="margin-top:120px;margin-left:120px;float:left;z-index:100;position:relative;background: #25a1c3;width: 250px;height: 1000px;text-align: center;display: inline-block;vertical-align: middle;height: 100%; left: -3px;">
		...
		<div id="section_div" style="postion: relative; left: 5px; top: 18px; width: 1570px;">
			...
			<div class="row 200%"  style="postion: relative; left: 105px;">
				<div class="12u">
					<!-- Table -->
					<c:if test="${empty myjoinList }">
						<b><strong style="position: relative; left: 45px;">가입한 동호회가 없어요. </strong></b>
												...
												<div class="btn-group"
													...
													<a href="#" class="button small"
														style="color: white; width: 108px; height: 35px; position: relative;"><p
															style="position: relative; left: -12px; font-size: 15px;" onclick="OpenWindow('<%=request.getContextPath()%>/club/detail?club_no=${club.club_no }','','825','650');">상세보기</p></a>
