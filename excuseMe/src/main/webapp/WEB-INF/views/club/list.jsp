...
<body>
	...
	<!-- 검색창 -->
	<div class="searchbox">
		동호회명: <input type="text" id="keyword" name="keyword" placeholder="검색할 동호회를 입력하세요." value="${keyword }" />
		<button type="button" id="searchKeywordBtn" onclick="SearchKeyword('${keyword}');">검색</button>
	</div> 
	
	<script>
		function SearchKeyword(keyword){
			form.action="<%=request.getContextPath()%>/club/list";
			form.submit();
		}
	</script>
...
<!-- <body class="subpage"> -->
		...
		<div class="text-center">
			<ul class="pagination ">
				<li class="page-item"><a class="page-link" href="listSearch${pageMaker.makeQuery(1)}">&lt;&lt;</a> 
				<li class="page-item">
				...
				<c:forEach begin="${pageMaker.startPage }" end="${pageMaker.endPage }" var="pageNum">
					<li class="page-item <c:out value="${pageMaker.cri.page == pageNum ?'active':''}"/>">
						<a class="page-link" href="listSearch${pageMaker.makeQuery(pageNum) }"> ${pageNum }</a>
					</li>
				</c:forEach>

				<li class="page-item">
					<a class="page-link" href="list <c:if test="${pageMaker.next }">
				...
				<li class="page-item"><a class="page-link" href="list${pageMaker.makeQuery(pageMaker.realEndPage) }">&gt;&gt; </a></li>
