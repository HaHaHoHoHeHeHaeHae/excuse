							...
							<div class="card-body">
								<!-- Table -->
							  	...
							  	<tr>
									...
									<a href="#" data-name="member" style="text-decoration: none; color: gray;" onclick="OpenWindow('detail?mem_id=${member.mem_id }','','850','800');">
										${member.mem_id }
									</a>
									</td>
									...
									<td>
									<button type="button" class="button special small" id="closeBtn" onclick="OpenWindow('replyList?mem_id=${member.mem_id }','','850','800');">댓글내역</button>
									</td>
								</tr>
							  </c:forEach>
							</c:if>
