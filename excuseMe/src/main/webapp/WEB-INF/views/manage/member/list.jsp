	...
	<section id="main" class="wrapper">
		<div class="inner" style="margin-left: -3px;">
			...
			<div class="row" style="margin-left:400px; "  >
									...
									<button class="button alt small" type="button" id="ali1" name="ali1" onclick="ali1();"  >가입오래된순</button> 
									<button class="button alt small" type="button" id="ali2" name="ali2" onclick="ali2();">가입최신순</button>
									</div>
