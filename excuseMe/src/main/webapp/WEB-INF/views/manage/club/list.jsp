	...
	<section class="sort">
		<div class="row"  style="margin-left:270px;" >
			 <div name="aliType"  id="aliType">
				<button class="button alt small" style="margin-top: 20px;" type="button" id="ali1" name="ali1" value="#ccf" onclick=a(this)>생성 오래된순</button> 
				<button class="button alt small" style="margin-top: 20px;" type="button" id="ali2" name="ali2" value="#ccf" onclick=a(this)>생성 최신순</button>
			</div> 
			
			<select name="sortType"  id="sortType" style="width:100px; margin-left:20px; margin-top:20px; margin-bottom:4px; height:45px;">
