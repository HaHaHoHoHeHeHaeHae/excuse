...
<body>
	...
	<div class="inner" style="width:98%;">
		...
		<div class="row" style="margin-top:10px; margin-left:30px;">
			<div>
				<h5 style="font-weight:bold;margin-top:5px;color:#768d99;">등록기간</h5>
			</div>
			<div>
				<h5 style="margin-top:5px;margin-left:40px;"><fmt:formatDate value="${notice.not_startDate}" pattern="yyyy-MM-dd HH:mm:ss" />&nbsp-&nbsp<fmt:formatDate value="${notice.not_endDate}" pattern="yyyy-MM-dd HH:mm:ss" /></h5>
			</div>
		</div>
