...
<body>
	...
	<div class="inner" style="width:98%;">
		...
		<div class="row" style="border-bottom:1px solid gray">
			<h2 style="margin-left:40px; margin-bottom:20px; font-weight:900; color:#4f9cc2;">공지사항 수정</h2>
		</div>
		<input type="hidden" id="not_no" name="not_no" value="${notice.not_no }">
		<input type="hidden" id="not_startDate" name="not_startDate" value="<fmt:formatDate value="${notice.not_startDate}" pattern="yyyy-MM-dd" />" />
		<input type="hidden" id="not_endDate" name="not_endDate" value="<fmt:formatDate value="${notice.not_endDate}" pattern="yyyy-MM-dd" />"  />
		<div class="row" style="margin-top:20px; margin-left:30px;">
			<div >
				<h5 style="font-weight:bold;margin-top:5px;color:#768d99;">제&nbsp&nbsp&nbsp&nbsp&nbsp목</h5>
			</div>
			<div>
				<input type="text" class="form-control" id="not_title" name="not_title" style="margin-left:50px; width:600px;" value="${notice.not_title }">
			</div>
		</div>
		<div class="row" style="margin-top:10px; margin-left:30px;">
			...
			<div>
				<input type="text" id="startEndDate" name="startEndDate" class="form-control" style="margin-left:50px; width:300px;">
			</div>
		</div>
		...
		<div class="text-center" style="margin-left:420px;">
			<div class="row">
				<div >
					<button type="button" class="btn btn-block btn-info" onclick="modifyNotice()" style="width:100px;">수정하기</button>
				</div>
